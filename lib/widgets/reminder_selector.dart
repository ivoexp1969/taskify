...
class ReminderSelector extends StatelessWidget {
  ...
  static const Map<String, Map<String, String>> reminderLabels = {
    ...
    'minus_15m': {
      'en': '15 minutes before', 'nl': '15 minuten ervoor', 'uk': 'За 15 хвилин', 'bg': '15 минути преди', 'de': '15 Minuten vorher',
    ...
    'minus_5m': {
      'en': '5 minutes before', 'nl': '5 minuten ervoor', 'uk': 'За 5 хвилин', 'bg': '5 минути преди', 'de': '5 Minuten vorher',
    ...
    'at_time': {
      'en': 'At due time', 'nl': 'Op de vervaltijd', 'uk': 'У момент виконання', 'bg': 'В точното време', 'de': 'Zur Fälligkeit',
    ...
    'same_day_8': {
      'en': 'Same day at 8:00', 'nl': 'Dezelfde dag om 8:00', 'uk': 'Того ж дня о 8:00', 'bg': 'Същия ден в 8:00', 'de': 'Am selben Tag um 8:00',
  ...
  static const Map<String, Map<String, String>> longLeadLabels = {
    'minus_2mo': {
      'en': '2 months before', 'nl': '2 maanden ervoor', 'uk': 'За 2 місяці', 'bg': '2 месеца преди', 'de': '2 Monate vorher',
      'fr': '2 mois avant', 'it': '2 mesi prima', 'el': '2 μήνες πριν',
      'es': '2 meses antes', 'pt': '2 meses antes', 'ru': 'За 2 месяца', 'tr': '2 ay önce', 'ja': '2か月前',
    },
    'minus_1mo': {
      'en': '1 month before', 'nl': '1 maand ervoor', 'uk': 'За 1 місяць', 'bg': '1 месец преди', 'de': '1 Monat vorher',
      'fr': '1 mois avant', 'it': '1 mese prima', 'el': '1 μήνα πριν',
      'es': '1 mes antes', 'pt': '1 mês antes', 'ru': 'За 1 месяц', 'tr': '1 ay önce', 'ja': '1か月前',
    },
    'minus_2w': {
      'en': '2 weeks before', 'nl': '2 weken ervoor', 'uk': 'За 2 тижні', 'bg': '2 седмици преди', 'de': '2 Wochen vorher',
    ...
    'minus_1w': {
      'en': '1 week before', 'nl': '1 week ervoor', 'uk': 'За 1 тиждень', 'bg': '1 седмица преди', 'de': '1 Woche vorher',
    ...
    'minus_3d': {
      'en': '3 days before', 'nl': '3 dagen ervoor', 'uk': 'За 3 дні', 'bg': '3 дни преди', 'de': '3 Tage vorher',
  ...
  static const Map<String, String> noReminderLabels = {
    'en': 'No reminder', 'nl': 'Geen herinnering', 'uk': 'Без нагадування', 'bg': 'Без напомняне', 'de': 'Keine Erinnerung',
