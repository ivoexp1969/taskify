...
const _p = {
  'thanksPro': {'en': 'Thank you! You are now Pro!', 'bg': 'Благодарим ти! Вече си Pro!', 'de': 'Danke! Du bist jetzt Pro!', 'fr': 'Merci! Vous êtes maintenant Pro!', 'it': 'Grazie! Ora sei Pro!', 'el': 'Ευχαριστούμε! Είσαι πλέον Pro!', 'es': '¡Gracias! ¡Ahora eres Pro!', 'pt': 'Obrigado! Agora você é Pro!', 'ru': 'Спасибо! Теперь вы Pro!', 'tr': 'Teşekkürler! Artık Pro\'sunuz!', 'ja': 'ありがとうございます！Proになりました！'},
  'error': {'en': 'Error', 'bg': 'Грешка', 'de': 'Fehler', 'fr': 'Erreur', 'it': 'Errore', 'el': 'Σφάλμα', 'es': 'Error', 'pt': 'Erro', 'ru': 'Ошибка', 'tr': 'Hata', 'ja': 'エラー'},
  'purchasesRestored': {'en': 'Purchases restored!', 'bg': 'Покупките са възстановени!', 'de': 'Käufe wiederhergestellt!', 'fr': 'Achats restaurés!', 'it': 'Acquisti ripristinati!', 'el': 'Οι αγορές επαναφέρθηκαν!', 'es': '¡Compras restauradas!', 'pt': 'Compras restauradas!', 'ru': 'Покупки восстановлены!', 'tr': 'Satın almalar geri yüklendi!', 'ja': '購入を復元しました！'},
  'noPurchases': {'en': 'No purchases found', 'bg': 'Няма намерени покупки', 'de': 'Keine Käufe gefunden', 'fr': 'Aucun achat trouvé', 'it': 'Nessun acquisto trovato', 'el': 'Δεν βρέθηκαν αγορές', 'es': 'No se encontraron compras', 'pt': 'Nenhuma compra encontrada', 'ru': 'Покупки не найдены', 'tr': 'Satın alma bulunamadı', 'ja': '購入が見つかりません'},
  'webFree': {'en': 'Web version is free!', 'bg': 'Web версията е безплатна!', 'de': 'Die Web-Version ist kostenlos!', 'fr': 'La version web est gratuite!', 'it': 'La versione web è gratuita!', 'el': 'Η web έκδοση είναι δωρεάν!', 'es': '¡La versión web es gratuita!', 'pt': 'A versão web é gratuita!', 'ru': 'Веб-версия бесплатна!', 'tr': 'Web sürümü ücretsiz!', 'ja': 'ウェブ版は無料です！'},
  ...
  'gotIt': {'en': 'Got it', 'bg': 'Разбрах', 'de': 'Verstanden', 'fr': 'Compris', 'it': 'Capito', 'el': 'Κατάλαβα', 'es': 'Entendido', 'pt': 'Entendi', 'ru': 'Понятно', 'tr': 'Anladım', 'ja': '了解'},
  'restore': {'en': 'Restore', 'bg': 'Възстанови', 'de': 'Wiederherstellen', 'fr': 'Restaurer', 'it': 'Ripristina', 'el': 'Επαναφορά', 'es': 'Restaurar', 'pt': 'Restaurar', 'ru': 'Восстановить', 'tr': 'Geri yükle', 'ja': '復元'},
  'tryAgain': {'en': 'Try again', 'bg': 'Опитай отново', 'de': 'Erneut versuchen', 'fr': 'Réessayer', 'it': 'Riprova', 'el': 'Δοκιμάστε ξανά', 'es': 'Intentar de nuevo', 'pt': 'Tentar novamente', 'ru': 'Попробовать снова', 'tr': 'Tekrar dene', 'ja': 'もう一度'},
  ...
  'havePromo': {'en': 'Have a promo code?', 'bg': 'Имаш промо код?', 'de': 'Hast du einen Promo-Code?', 'fr': 'Avez-vous un code promo?', 'it': 'Hai un codice promo?', 'el': 'Έχετε κωδικό προσφοράς;', 'es': '¿Tienes un código promocional?', 'pt': 'Tem um código promocional?', 'ru': 'Есть промокод?', 'tr': 'Promosyon kodunuz var mı?', 'ja': 'プロモコードをお持ちですか？'},
  'enterCode': {'en': 'Enter code', 'bg': 'Въведи код', 'de': 'Code eingeben', 'fr': 'Entrez le code', 'it': 'Inserisci codice', 'el': 'Εισάγετε κωδικό', 'es': 'Ingrese código', 'pt': 'Digite código', 'ru': 'Введите код', 'tr': 'Kodu girin', 'ja': 'コードを入力'},
  'apply': {'en': 'Apply', 'bg': 'Приложи', 'de': 'Anwenden', 'fr': 'Appliquer', 'it': 'Applica', 'el': 'Εφαρμογή', 'es': 'Aplicar', 'pt': 'Aplicar', 'ru': 'Применить', 'tr': 'Uygula', 'ja': '適用'},
  'noProducts': {'en': 'No products available', 'bg': 'Няма налични продукти', 'de': 'Keine Produkte verfügbar', 'fr': 'Aucun produit disponible', 'it': 'Nessun prodotto disponibile', 'el': 'Δεν υπάρχουν διαθέσιμα προϊόντα', 'es': 'No hay productos disponibles', 'pt': 'Nenhum produto disponível', 'ru': 'Нет доступных продуктов', 'tr': 'Ürün bulunamadı', 'ja': '利用可能な商品がありません'},
  'unlimited': {'en': 'Unlimited tasks', 'bg': 'Неограничени задачи', 'de': 'Unbegrenzte Aufgaben', 'fr': 'Tâches illimitées', 'it': 'Attività illimitate', 'el': 'Απεριόριστες εργασίες', 'es': 'Tareas ilimitadas', 'pt': 'Tarefas ilimitadas', 'ru': 'Безлимитные задачи', 'tr': 'Sınırsız görevler', 'ja': '無制限のタスク'},
  'customCat': {'en': 'Custom categories', 'bg': 'Персонализирани категории', 'de': 'Eigene Kategorien', 'fr': 'Catégories personnalisées', 'it': 'Categorie personalizzate', 'el': 'Προσαρμοσμένες κατηγορίες', 'es': 'Categorías personalizadas', 'pt': 'Categorias personalizadas', 'ru': 'Свои категории', 'tr': 'Özel kategoriler', 'ja': 'カスタムカテゴリー'},
  'multiRemind': {'en': 'Multiple reminders', 'bg': 'Множество напомняния', 'de': 'Mehrere Erinnerungen', 'fr': 'Rappels multiples', 'it': 'Promemoria multipli', 'el': 'Πολλαπλές υπενθυμίσεις', 'es': 'Múltiples recordatorios', 'pt': 'Múltiplos lembretes', 'ru': 'Множество напоминаний', 'tr': 'Çoklu hatırlatıcılar', 'ja': '複数のリマインダー'},
  'recurring': {'en': 'Recurring tasks', 'bg': 'Повтарящи се задачи', 'de': 'Wiederkehrende Aufgaben', 'fr': 'Tâches récurrentes', 'it': 'Attività ricorrenti', 'el': 'Επαναλαμβανόμενες εργασίες', 'es': 'Tareas recurrentes', 'pt': 'Tarefas recorrentes', 'ru': 'Повторяющиеся задачи', 'tr': 'Tekrarlayan görevler', 'ja': '繰り返しタスク'},
  'calView': {'en': 'Calendar view', 'bg': 'Календарен изглед', 'de': 'Kalenderansicht', 'fr': 'Vue calendrier', 'it': 'Vista calendario', 'el': 'Προβολή ημερολογίου', 'es': 'Vista de calendario', 'pt': 'Visualização de calendário', 'ru': 'Вид календаря', 'tr': 'Takvim görünümü', 'ja': 'カレンダー表示'},
  'stats': {'en': 'Statistics', 'bg': 'Статистики', 'de': 'Statistiken', 'fr': 'Statistiques', 'it': 'Statistiche', 'el': 'Στατιστικά', 'es': 'Estadísticas', 'pt': 'Estatísticas', 'ru': 'Статистика', 'tr': 'İstatistikler', 'ja': '統計'},
  'cloudSync': {'en': 'Cloud sync', 'bg': 'Облачна синхронизация', 'de': 'Cloud-Sync', 'fr': 'Synchronisation cloud', 'it': 'Sincronizzazione cloud', 'el': 'Συγχρονισμός cloud', 'es': 'Sincronización en la nube', 'pt': 'Sincronização na nuvem', 'ru': 'Облачная синхронизация', 'tr': 'Bulut senkronizasyonu', 'ja': 'クラウド同期'},
  'voiceInput': {'en': 'Voice input', 'bg': 'Гласов вход', 'de': 'Spracheingabe', 'fr': 'Saisie vocale', 'it': 'Input vocale', 'el': 'Φωνητική εισαγωγή', 'es': 'Entrada de voz', 'pt': 'Entrada de voz', 'ru': 'Голосовой ввод', 'tr': 'Sesli giriş', 'ja': '音声入力'},
  'allThemes': {'en': 'All themes', 'bg': 'Всички теми', 'de': 'Alle Themen', 'fr': 'Tous les thèmes', 'it': 'Tutti i temi', 'el': 'Όλα τα θέματα', 'es': 'Todos los temas', 'pt': 'Todos os temas', 'ru': 'Все темы', 'tr': 'Tüm temalar', 'ja': 'すべてのテーマ'},
  'noAds': {'en': 'No ads', 'bg': 'Без реклами', 'de': 'Keine Werbung', 'fr': 'Sans publicité', 'it': 'Senza pubblicità', 'el': 'Χωρίς διαφημίσεις', 'es': 'Sin anuncios', 'pt': 'Sem anúncios', 'ru': 'Без рекламы', 'tr': 'Reklamsız', 'ja': '広告なし'},
  'lifetime': {'en': 'Lifetime', 'bg': 'Завинаги', 'de': 'Lebenslang', 'fr': 'À vie', 'it': 'A vita', 'el': 'Εφ\' όρου ζωής', 'es': 'De por vida', 'pt': 'Vitalício', 'ru': 'Навсегда', 'tr': 'Ömür boyu', 'ja': '買い切り'},
  'yearly': {'en': 'Yearly', 'bg': 'Годишен', 'de': 'Jährlich', 'fr': 'Annuel', 'it': 'Annuale', 'el': 'Ετήσιο', 'es': 'Anual', 'pt': 'Anual', 'ru': 'Годовой', 'tr': 'Yıllık', 'ja': '毎年'},
  'monthly': {'en': 'Monthly', 'bg': 'Месечен', 'de': 'Monatlich', 'fr': 'Mensuel', 'it': 'Mensile', 'el': 'Μηνιαίο', 'es': 'Mensual', 'pt': 'Mensal', 'ru': 'Месячный', 'tr': 'Aylık', 'ja': '毎月'},
  'oneTime': {'en': 'One-time payment', 'bg': 'Еднократно плащане', 'de': 'Einmalzahlung', 'fr': 'Paiement unique', 'it': 'Pagamento unico', 'el': 'Εφάπαξ πληρωμή', 'es': 'Pago único', 'pt': 'Pagamento único', 'ru': 'Единоразовый платёж', 'tr': 'Tek seferlik ödeme', 'ja': '1回限りの支払い'},
