...
class AppText {
  ...
  // ==================== QUICK ADD ====================
  String get quickAddDone => _t({'en': 'Task added', 'bg': 'Задачата е добавена', 'de': 'Aufgabe hinzugefügt', 'fr': 'Tâche ajoutée', 'it': 'Attività aggiunta', 'el': 'Εργασία προστέθηκε', 'es': 'Tarea añadida', 'pt': 'Tarefa adicionada', 'ru': 'Задача добавлена', 'tr': 'Görev eklendi'});

  // ==================== ONBOARDING FEATURES PAGE ====================
  String get onboardingFeaturesTitle => _t({'en': 'Power features', 'bg': 'Мощни функции', 'de': 'Starke Funktionen', 'fr': 'Fonctionnalités avancées', 'it': 'Funzionalità potenti', 'el': 'Ισχυρές δυνατότητες', 'es': 'Funciones potentes', 'pt': 'Recursos avançados', 'ru': 'Мощные функции', 'tr': 'Güçlü özellikler'});
  ...
  String get onboardingFeatureStreak => _t({'en': 'Daily Streak — track your productivity momentum', 'bg': 'Дневна серия — следи продуктивността си', 'de': 'Tages-Serie — verfolge deine Produktivität', 'fr': 'Série quotidienne — suivez votre élan productif', 'it': 'Serie giornaliera — monitora la tua produttività', 'el': 'Ημερήσια σερί — παρακολούθηση παραγωγικότητας', 'es': 'Racha diaria — sigue tu impulso de productividad', 'pt': 'Sequência diária — acompanhe sua produtividade', 'ru': 'Дневная серия — следи за своей продуктивностью', 'tr': 'Günlük seri — üretkenlik momentumunu takip et'});
  ...
  String get onboardingAiVoice => _t({'en': 'Tap the microphone and just speak. Your words turn into a task and are parsed automatically.', 'bg': 'Натисни микрофона и просто говори. Думите ти стават задача и се анализират автоматично.', 'de': 'Tippe auf das Mikrofon und sprich einfach. Deine Worte werden zur Aufgabe und automatisch analysiert.', 'fr': 'Touchez le micro et parlez simplement. Vos mots deviennent une tâche, analysée automatiquement.', 'it': 'Tocca il microfono e parla. Le tue parole diventano un\'attività, analizzata automaticamente.', 'el': 'Πάτα το μικρόφωνο και απλώς μίλα. Τα λόγια σου γίνονται εργασία και αναλύονται αυτόματα.', 'es': 'Toca el micrófono y habla. Tus palabras se convierten en una tarea y se analizan automáticamente.', 'pt': 'Toca no microfone e fala. As tuas palavras viram uma tarefa e são analisadas automaticamente.', 'ru': 'Нажми на микрофон и просто говори. Твои слова станут задачей и проанализируются автоматически.', 'tr': 'Mikrofona dokun ve konuş. Sözlerin otomatik olarak göreve dönüşür ve ayrıştırılır.'});
  String get onboardingAiNote => _t({'en': 'Premium feature · replies in your language · up to 20 AI requests per day.', 'bg': 'Premium функция · отговаря на твоя език · до 20 AI заявки на ден.', 'de': 'Premium-Funktion · antwortet in deiner Sprache · bis zu 20 KI-Anfragen pro Tag.', 'fr': 'Fonction Premium · répond dans votre langue · jusqu\'à 20 requêtes IA par jour.', 'it': 'Funzione Premium · risponde nella tua lingua · fino a 20 richieste IA al giorno.', 'el': 'Λειτουργία Premium · απαντά στη γλώσσα σου · έως 20 αιτήματα AI την ημέρα.', 'es': 'Función Premium · responde en tu idioma · hasta 20 solicitudes de IA al día.', 'pt': 'Recurso Premium · responde no teu idioma · até 20 pedidos de IA por dia.', 'ru': 'Premium-функция · отвечает на твоём языке · до 20 запросов к ИИ в день.', 'tr': 'Premium özellik · senin dilinde yanıtlar · günde 20 AI isteğine kadar.'});

  // ==================== EISENHOWER MATRIX ====================
  String get matrix => _t({'en': 'Matrix', 'bg': 'Матрица', 'de': 'Matrix', 'fr': 'Matrice', 'it': 'Matrice', 'el': 'Μήτρα', 'es': 'Matriz', 'pt': 'Matriz', 'ru': 'Матрица', 'tr': 'Matris'});
  String get matrixDoFirst => _t({'en': 'Do First', 'bg': 'Правя сега', 'de': 'Sofort erledigen', 'fr': 'Faire maintenant', 'it': 'Fai subito', 'el': 'Κάνε πρώτα', 'es': 'Hacer ya', 'pt': 'Fazer agora', 'ru': 'Сделать сейчас', 'tr': 'Hemen Yap'});
  String get matrixSchedule => _t({'en': 'Schedule', 'bg': 'Планирам', 'de': 'Planen', 'fr': 'Planifier', 'it': 'Pianifica', 'el': 'Προγραμμάτισε', 'es': 'Planificar', 'pt': 'Planejar', 'ru': 'Запланировать', 'tr': 'Planla'});
  String get matrixDelegate => _t({'en': 'Delegate', 'bg': 'Делегирам', 'de': 'Delegieren', 'fr': 'Déléguer', 'it': 'Delega', 'el': 'Ανάθεσε', 'es': 'Delegar', 'pt': 'Delegar', 'ru': 'Делегировать', 'tr': 'Devret'});
  String get matrixEliminate => _t({'en': 'Eliminate', 'bg': 'Изтрий', 'de': 'Eliminieren', 'fr': 'Éliminer', 'it': 'Elimina', 'el': 'Εξάλειψε', 'es': 'Eliminar', 'pt': 'Eliminar', 'ru': 'Устранить', 'tr': 'Yok Et'});
  String get matrixUrgentImportant => _t({'en': 'Urgent • Important', 'bg': 'Спешно • Важно', 'de': 'Dringend • Wichtig', 'fr': 'Urgent • Important', 'it': 'Urgente • Importante', 'el': 'Επείγον • Σημαντικό', 'es': 'Urgente • Importante', 'pt': 'Urgente • Importante', 'ru': 'Срочно • Важно', 'tr': 'Acil • Önemli'});
  String get matrixImportantOnly => _t({'en': 'Important • Not urgent', 'bg': 'Важно • Не спешно', 'de': 'Wichtig • Nicht dringend', 'fr': 'Important • Pas urgent', 'it': 'Importante • Non urgente', 'el': 'Σημαντικό • Μη επείγον', 'es': 'Importante • No urgente', 'pt': 'Importante • Não urgente', 'ru': 'Важно • Не срочно', 'tr': 'Önemli • Acil değil'});
  String get matrixUrgentOnly => _t({'en': 'Urgent • Not important', 'bg': 'Спешно • Не важно', 'de': 'Dringend • Nicht wichtig', 'fr': 'Urgent • Pas important', 'it': 'Urgente • Non importante', 'el': 'Επείγον • Μη σημαντικό', 'es': 'Urgente • No importante', 'pt': 'Urgente • Não importante', 'ru': 'Срочно • Не важно', 'tr': 'Acil • Önemli değil'});
  String get matrixNeither => _t({'en': 'Not urgent • Not important', 'bg': 'Не спешно • Не важно', 'de': 'Nicht dringend • Nicht wichtig', 'fr': 'Pas urgent • Pas important', 'it': 'Non urgente • Non importante', 'el': 'Μη επείγον • Μη σημαντικό', 'es': 'No urgente • No importante', 'pt': 'Não urgente • Não importante', 'ru': 'Не срочно • Не важно', 'tr': 'Acil değil • Önemli değil'});
  String get matrixEmpty => _t({'en': 'No tasks', 'bg': 'Няма задачи', 'de': 'Keine Aufgaben', 'fr': 'Aucune tâche', 'it': 'Nessuna attività', 'el': 'Δεν υπάρχουν εργασίες', 'es': 'Sin tareas', 'pt': 'Sem tarefas', 'ru': 'Нет задач', 'tr': 'Görev yok'});
  String get matrixUrgent => _t({'en': 'Urgent', 'bg': 'Спешно', 'de': 'Dringend', 'fr': 'Urgent', 'it': 'Urgente', 'el': 'Επείγον', 'es': 'Urgente', 'pt': 'Urgente', 'ru': 'Срочно', 'tr': 'Acil'});
  ...
  String get aiBreakdownAction => _t({'en': 'Break into steps', 'bg': 'Разбий на стъпки', 'de': 'In Schritte aufteilen', 'fr': 'Diviser en étapes', 'it': 'Dividi in passaggi', 'el': 'Ανάλυση σε βήματα', 'es': 'Dividir en pasos', 'pt': 'Dividir em etapas', 'ru': 'Разбить на шаги', 'tr': 'Adımlara böl'});
