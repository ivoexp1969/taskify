...
class AppText {
  ...
  String get open => _t({'en': 'Open', 'bg': 'Отвори', 'de': 'Öffnen', 'fr': 'Ouvrir', 'it': 'Apri', 'el': 'Άνοιγμα', 'es': 'Abrir', 'pt': 'Abrir', 'ru': 'Открыть', 'tr': 'Aç', 'ja': '開く'});
  String get dismiss => _t({'en': 'Dismiss', 'bg': 'Скрий', 'de': 'Ausblenden', 'fr': 'Masquer', 'it': 'Nascondi', 'el': 'Απόρριψη', 'es': 'Descartar', 'pt': 'Dispensar', 'ru': 'Скрыть', 'tr': 'Kapat', 'ja': '閉じる'});

  // ==================== ОЩЕ ОТ 1969 (кръстосана промоция „Навици") ====================
  String get moreFrom1969Title => _t({'en': 'More from 1969', 'bg': 'Още от 1969', 'de': 'Mehr von 1969', 'fr': 'Plus de 1969', 'it': 'Altro da 1969', 'el': 'Περισσότερα από το 1969', 'es': 'Más de 1969', 'pt': 'Mais de 1969', 'ru': 'Ещё от 1969', 'tr': "1969'dan daha fazlası", 'ja': '1969のその他のアプリ'});
  String get moreFrom1969NaviciTitle => _t({'en': 'Навици (Habits)', 'bg': 'Навици', 'de': 'Навици (Gewohnheiten)', 'fr': 'Навици (Habitudes)', 'it': 'Навици (Abitudini)', 'el': 'Навици (Συνήθειες)', 'es': 'Навици (Hábitos)', 'pt': 'Навици (Hábitos)', 'ru': 'Навици (Привычки)', 'tr': 'Навици (Alışkanlıklar)', 'ja': 'Навици（習慣）'});
