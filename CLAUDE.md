...
- **Контакти с имен ден — on-device, с латиница (PC, нова работа в същата v1.0.46+54 — НЕ качена):**
  ...
  **100% on-device — нито едно име не напуска телефона**, нищо в облак/Firestore. Toggle в Настройки →
  ...
  грешки, **release APK билднат ✅ (71.4MB)** (телефонът не беше свързан → жив тест чака). ⚠️ Play Console
  ще иска **декларация за чувствително разрешение (READ_CONTACTS)** при следващото качване на AAB. Виж DEVLOG.
