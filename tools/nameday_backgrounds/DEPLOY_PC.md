...
## Къде са снимките
**18-те готови снимки са ТУК в repo-то:** `tools/nameday_backgrounds/bg-01.jpg … bg-18.jpg`
(Unsplash, без хора/лога, 1080×1350, компресирани <250KB. Свалени и тествани на Mac.)
Сайтът има **избор на фон с миниатюри** (потребителят кликва снимка преди генериране).
